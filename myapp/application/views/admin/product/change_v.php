                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="/admin/product/update_product/<?php echo $product_info->id?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="product_image" type="hidden" value="<?php echo $product_info->product_image?>" />
                                </div>
                                ...
                                <div class="form-group" >
                                    ...
                                    <select class="form-control" id="primary_category">
                                        <?php foreach($primary_category as $category): ?>
                                            <option value="<?php echo $category->id;?>"
                                                    <?php echo $category->id == $product_info->parent_id ? 'selected' : ''?>>
                                    ...
                                    <select class="form-control" name="category" id="category">
                                        <?php foreach($brother_category as $category): ?>
                                            <option value="<?php echo $category->id;?>"
                                                    <?php echo $category->id == $product_info->category_id ? 'selected' : ''?>>
                                                <?php echo $category->name;?>
                                            </option>
                                        <?php endforeach;?>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label>규격</label>
                                    <input class="form-control"
                                           placeholder="50cm(w) x 100cm(h) x 60cm"
                                           value="<?php echo $product_info->size?>"
                                           name="size">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                           placeholder="참나무"
                                           value="<?php echo $product_info->quality?>"
                                           name="quality">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>특징</label>
                                    <input class="form-control"
                                           value="<?php echo $product_info->feature?>"
                                           name="feature">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"
                                              name="detail"><?php echo $product_info->detail?></textarea>
                                </div>
                            </form>
                        </div>
                        <!-- /.panel-body -->
