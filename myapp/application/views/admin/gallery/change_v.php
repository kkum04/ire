                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="/admin/gallery/update_gallery/<?php echo $gallery_info->id?>" method="POST">
                                <div class="form-group">
                                    <label>갤러리 제목</label>
                                    <input class="form-control"
                                           placeholder="갤러리 제목"
                                           name="title"
                                           value="<?php echo $gallery_info->title?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="image"
                                           type="hidden"
                                           value="<?php echo $gallery_info->image?>" />
                                </div>
                                    ...
                                    <select class="form-control" name="category">
                                        <?php foreach($gallery_category_list as $category): ?>
                                            <option value="<?php echo $category->id;?>"
                                                    <?php echo $gallery_info->category_id == $category->id ? 'selected' : ''?>
                                            >
                                ...
                                <div class="form-group">
                                    <label>상세</label>
                                    <textarea class="form-control" name="content"><?php echo $gallery_info->content ?></textarea>
                                </div>
                            </form>
                        </div>
                        <!-- /.panel-body -->
    ...
    <script>
        $(function (){
            CKEDITOR.replace( 'content', {
                customConfig: '/js/ckeditor/config.js?temp=12345'
            } );
