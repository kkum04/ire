...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    ...
                                    <tr class="odd gradeX">
                                        <td>
                                            <a class="btn btn-primary"
                                               href="/admin/banner/main/update_order/<?php echo $main_banner->banner_id?>/prev">
                                                ▲
                                            </a>
                                            <a class="btn btn-primary"
                                               href="/admin/banner/main/update_order/<?php echo $main_banner->banner_id?>/next">
                                                ▼
                                            </a>
                                        </td>
                                        <td><?php echo $main_banner->button_text?></td>
                                        <td><?php echo $main_banner->link?></td>
                                        <td>
                                            <a class="btn btn-default"
                                               href="/admin/banner/main/update_form/<?php echo $main_banner->banner_id?>">
                                                수정
                                            </a>
                                            <a class="btn btn-danger btn_delete_main_banner"
                                                href="/admin/banner/main/delete/<?php echo $main_banner->banner_id?>">
                                                삭제
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <a class="btn btn-default"
                               href="/admin/banner/main/create_form">
                                추가
                            </a>
                        </div>
                        <!-- /.panel-body -->
    ...
    <script>
        $(function (){
            $('.btn_delete_main_banner').click(function (){
                return confirm("메인배너를 삭제하시겠습니까?");
            });
        });
    </script>
